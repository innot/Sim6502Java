...
public class Sim6522Input {
	...
	/** Reset, active low **/
	public boolean reset = false;	// todo: implement RESET logic. For now, use Sim6522.reset() method instead.
	...
	public Sim6522Input copy() {
		Sim6522Input inp = new Sim6522Input();
		inp.data = this.data;
		inp.cs1 = this.cs1;
