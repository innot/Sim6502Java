...
The 6502 test are taken from https://github.com/Klaus2m5/6502_65C02_functional_tests
They are written and Copyright (C) 2012-2020 by Klaus Dormann, licensed under the GPL V3.

A few small modifications were made to use them for testing the Sim6502Java program, mainly
to report failure/success by writing to memory location $f000 resp. $f001.
